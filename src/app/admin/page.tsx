...
export default function AdminDashboard() {
  const [reports, setReports] = useState<Report[]>([
    {
      ...
      description: 'Unusual water coloration spotted. Multiple fish deaths observed.',
    ...
    },
    {
      ...
      description: 'Small oil spill detected from cargo vessel. Immediate cleanup required.',
  ...
  const updateReportStatus = (reportId: number, newStatus: 'verified' | 'flagged' | 'fake') => {
    setReports(prev => 
      prev.map(report => 
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'flagged': return 'text-orange-400 bg-orange-900/30';
      case 'fake': return 'text-red-400 bg-red-900/30';
      default: return 'text-gray-400 bg-gray-900/30';
    }
  };
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-4">
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gray-900 p-4 rounded-xl border border-gray-800">
              <div className="text-center">
                <p className="text-2xl font-bold text-orange-400">{reports.filter(r => r.status === 'flagged').length}</p>
                <p className="text-xs text-gray-400">Flagged</p>
              </div>
            </div>
            <div className="bg-gray-900 p-4 rounded-xl border border-gray-800">
              <div className="text-center">
                <p className="text-2xl font-bold text-red-400">{reports.filter(r => r.status === 'fake').length}</p>
            ...
            {filteredReports.map((report) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <img src={report.image} className="w-20 h-20 rounded-lg object-cover" alt="Report" />
        ...
        {selectedReport && (
          <div className="w-1/3 bg-gray-900 border-l border-gray-800 p-4">
            <div className="sticky top-0">
              ...
              <div className="space-y-4">
                <img src={selectedReport.image} className="w-full rounded-lg" alt="Report" />
                
                <div>
                  <h3 className="font-semibold text-white mb-2">{selectedReport.title}</h3>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className={`font-semibold ${getSeverityColor(selectedReport.severity).split(' ')[0]}`}>
                ...
                <div className="space-y-2 pt-4">
                  ...
                  <button 
                    onClick={() => updateReportStatus(selectedReport.id, 'flagged')}
                  ...
                  <button 
                    onClick={() => updateReportStatus(selectedReport.id, 'fake')}
