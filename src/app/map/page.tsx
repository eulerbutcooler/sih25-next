  ...
  return (
    <div className="max-w-md mx-auto h-screen bg-black overflow-y-auto pb-20">
      ...
      <div className="relative">
        <div className="h-64 bg-gray-900 flex items-center justify-center border-b border-gray-800">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Ocean Hazard Hotspots</p>
          </div>
        </div>
        
        {/* Map Controls */}
        <div className="absolute top-4 right-4 flex flex-col space-y-2">
          <button className="bg-black/70 backdrop-blur-lg p-2 rounded-lg border border-gray-700">
        ...
        {/* Legend */}
        <div className="absolute bottom-4 left-4 bg-black/70 backdrop-blur-lg p-3 rounded-lg border border-gray-700">
          <h3 className="text-xs font-semibold text-gray-300 mb-2">Severity Levels</h3>
      ...
      <div className="p-4">
        ...
        <div className="space-y-3">
          {hotspots.map((hotspot) => (
            <div key={hotspot.id} className="post-card bg-black rounded-xl p-4 border border-gray-800">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    <div className={`w-4 h-4 ${getSeverityColor(hotspot.severity)} rounded-full`}></div>
                  ...
                  <div className="flex items-center justify-between">
                    <span className={`text-sm font-semibold ${getSeverityTextColor(hotspot.severity)}`}>
      ...
      <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-black/70 backdrop-blur-lg border-t border-gray-800 flex justify-around p-2">
        ...
        <Link href="/map" className="text-amber-300 flex flex-col items-center justify-center w-full text-center p-2 rounded-lg">
