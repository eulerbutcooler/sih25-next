...
export default function MessagesPage() {
  ...
  return (
    <div
      ...
      className="max-w-md  mx-auto h-screen bg-black overflow-y-auto pb-12"
    >
      {/* Header */}
      ...
      <div className="p-4 border-t border-[#27272a] mt-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a href="tel:9305816308">
            <button className="w-full secondary-btn text-white font-semibold py-3 px-4 rounded-xl flex items-center justify-center space-x-2">
